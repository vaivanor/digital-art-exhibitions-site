...
<!DOCTYPE html>
  ...
  <body class="fonas" >
    ...
    <div class="container" id="divas">
      ...
      <?php 
        pPrisijungusioVartotojoAsmInfo();
      ?>

      <div class="divasd">
        <div class="skiltis" id="skiltis3">
          <p>REDAGUOTI DUOMENIS</p>
        </div>
      </div>

      <div class="justify-content-center divasu"> 

      <?php
        pPrisijungusioVartotojoDuomRed();  
      ?>
      ...
      <?php
        pPrisijungusioVartotojoSkelbtosPar();
      ?>
    </div>
