...
<!DOCTYPE html>
  ...
  <head>
    <title>A Vartotojo profilio peržiūra</title>
    <meta charset="utf-8">
  ...
  <body class="fonas" >
    ...
    <nav class="navbar navbar-expand-xl navbar-light justify-content-between fixed-top">
      <!--logotipas-->
      <a href="aPagrindinis.php" class="navbar-brand mb-0">
    ...
    <div class="container" id="divas">
      ...
      <div class="d-flex justify-content-start">
        <a href="aVartotojuProfiliai.php"><i id="rodykle" class="fas fa-chevron-left fa-2x" ></i></a>
      </div>
      
      <?php
         aVartotojoProfilioPerziuraAsmInfo();
      ?>

      <div class="divasd">
        <div class="skiltis" id="skiltis3">
          <p>SKELBTOS PARODOS</p>
        </div>
      </div>

      <?php
          aVartotojoProfilioPerziuraParNuot();
      ?>
