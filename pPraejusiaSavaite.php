...
<!DOCTYPE html>
  ...
  <body class="fonas" >
    ...
    <div class="container" id="divas">
      ...
      <div class="divasd">
        <div class="skiltis" id="skiltis3">
          <p>RAŠYTI ATSILIEPIMĄ</p>
        </div>
        <div class="skiltis4" >
          <p>Jūsų atsiliepimas:</p>
        </div>

        <form method="post" action="pPraejusiaSavaite.php">
          <div class="atsiliepimas">
            <textarea class="ivedimas" name="atsiliepimas"></textarea>
          </div>
          <div class="d-flex justify-content-center">
              <input type="submit" name="pateikti" value="Pateikti" id="paskyra" style="margin-bottom:20px">
          </div>
        </form>

        <?php
          praejusiSavaiteRasytiAtsiliepima();
        ?>
