  ...
  <body class="fonas" >
    ...
    <nav class="navbar navbar-expand-xl navbar-light justify-content-between fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item active" >
            <a href="index.php" class="nav-link" id="nava">
              ŠIĄ SAVAITĘ
            </a>
          </li>
          <!--praėjusią savaitę-->
          <li class="nav-item active" >
            <a href="nPraejusiaSavaite.php" class="nav-link" id="nava">
              PRAĖJUSIĄ SAVAITĘ
            </a>
          </li>  
        </ul>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav ms-auto mt-2 mt-lg-0 ">
            ...
            <!--apie mus-->
            <li class="nav-item active">
              <a href="nApieMus.php" class="nav-link" id="nava">
                APIE MUS
              </a>
            </li>
            <!--kalba-->
        ...
        <ul class="navbar-nav"> 
          ...
          <a href="nPagrindinis.php">
            <input type="submit" value="Prisijungti" id="paskyra" class="justify-content-end" style="margin-top: 0;">
          </a>
        </ul>
      </div>
    </nav>
    ...
    <div class="container" id="divas">
      ...
      <div class="d-flex justify-content-start">
        <a href="nPraejusiaSavaite.php"><i id="rodykle" class="fas fa-chevron-left fa-2x" ></i></a>
      </div>
    ...
    <footer class="d-flex  justify-content-center">
      ...
      <div id="infot" class="d-none d-xs-none d-sm-none d-md-none d-lg-block d-xl-block" >
        <p><a href="nApieMus.php">Apie mus</a></p>
