...
<!DOCTYPE html>
  ...
  <head>
    <title>Vartotojo profilio peržiūra</title>
    <meta charset="utf-8">
  ...
  <body class="fonas" >
    ...
    <div class="container" id="divas">
      ...
      <div class="d-flex justify-content-start">
        <a href="pVartotojuProfiliai.php"><i id="rodykle" class="fas fa-chevron-left fa-2x" ></i></a>
      </div>
      
      <?php
         pVartotojoProfilioPerziuraAsmInfo();
      ?>
      ...
      <?php
        pVartotojoProfilioPerziuraParNuot();
      ?>
